<html>
    <head>
        ...
        <?php
			...
			$ciutatsArray = $GeneralBD->runQuery("SELECT * FROM ciutat");
			$correus = $GeneralBD->runQuery1("SELECT correu FROM usuari");
			$GeneralBD->tancarBD();
			//Només guardem Array per nom de ciutat que abans teniem guardat dos posicions i no funcionaria amb autocomplete
			for($i=0;$i<count($ciutatsArray);$i++){
				$ciutats[$i] = $ciutatsArray[$i]['nom'];
			}
		?>
                    ...
                    <form  action="controlregistrar.php" method="post" id="formulariregistrar">
                      <div class="form-group">
                        ...
                        <div id="correudiv" class="has-feedback">
                        	<input type="email" class="form-control" id="correu" name="correu" placeholder="Correu" onChange="comprovarCamps(this.parentNode.id, this.id)" required><span id="correuicon" class="form-control-feedback glyphicon"></span></br>
                        </div>
                        <div class="row">
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="nom" name="nom" placeholder="Nom" onChange="comprovarCamps(this.parentNode.id, this.id)" required><span id="nomicon" class="form-control-feedback glyphicon"></span></br>
                        </div>
                        <div class="row">
                         	<div id="cognom1div" class="col-xs-6 has-feedback">
                        		<input type="text" class="form-control" id="cognom1" name="cognom1" placeholder="Primer cognom" onChange="comprovarCamps(this.parentNode.id, this.id)" required><span id="cognom1icon" class="form-control-feedback glyphicon"></span>
                         	</div>
                         	<div class="col-xs-6 has-feedback" id="cognom2div">
                        		<input type="text" class="form-control" id="cognom2" name="cognom2" placeholder="Segon cognom" onChange="comprovarCamps(this.parentNode.id, this.id)" required><span id="cognom2icon" class="form-control-feedback glyphicon"></span>
                        	</div>
                       </div></br>
                       <div class="row">
                         	<div class="col-xs-6 has-feedback" id="telefondiv">
                        		<input type="text" class="form-control" id="telefon" name="telefon" placeholder="Tel&eacute;fon" onChange="comprovarCamps(this.parentNode.id, this.id)" required><span id="telefonicon" class="form-control-feedback glyphicon"></span>
                        	</div>
                         	<div class="col-xs-6 has-feedback" id="data_naixdiv">
                        		<input type="text" class="form-control" id="data_naix" name="data_naix" placeholder="Data de naixament" onChange="comprovarCamps(this.parentNode.id, this.id)" required><span id="data_naixicon" class="form-control-feedback glyphicon"></span>
                            </div>
                       </div>
                      </div>
                      <div class="form-group">
                        ...
                        <div class="row">
                             <div class="col-xs-8 has-feedback" id="ciutatdiv">
                                <input type="text" class="form-control" id="ciutat" name="ciutat" placeholder="Ciutat" onChange="comprovarCamps(this.parentNode.id, this.id)" required><span id="ciutaticon" class="form-control-feedback glyphicon"></span>
                              </div>
                              <div class="col-xs-4 has-feedback" id="postaldiv">
                                <input type="text" class="form-control" id="postal" name="postal" placeholder="Postal" onChange="comprovarCamps(this.parentNode.id, this.id)" required><span id="postalicon" class="form-control-feedback glyphicon"></span>
                              </div>
                        </div></br>
                        <div id="carrerdiv" class="has-feedback">
                        	<input type="text" class="form-control" id="carrer" name="carrer" placeholder="Carrer" onChange="comprovarCamps(this.parentNode.id, this.id)" required><span id="carrericon" class="form-control-feedback glyphicon"></span></br>
                        </div>
                      	 <div class="row">
                             <div class="col-xs-4 has-feedback" id="numerodiv">
                                <input type="text" class="form-control" id="numero" name="numero" placeholder="N&uacute;mero" onChange="comprovarCamps(this.parentNode.id, this.id)" required><span id="numeroicon" class="form-control-feedback glyphicon"></span>
                              </div>
