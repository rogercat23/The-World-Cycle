                      ...
                      <div class="form-group">
                        ...
                        <div class="row">
                             <div class="col-xs-8 has-feedback" id="ciutatdiv">
                                <input type="text" class="form-control" id="ciutat" name="ciutat" placeholder="Ciutat" onChange="comprovarCamps(this.id)" title="Es obligatori!" required><span id="ciutaticon" class="form-control-feedback glyphicon"></span>
                              </div>
